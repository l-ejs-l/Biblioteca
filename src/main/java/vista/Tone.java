...
public class Tone {
    ...
    /**
     * Makes a pleasant beep. I didn't invent the logic for this, it's been posted various places
     * online. Earliest example I can find is from 2008:
    ...
    public static void sound(final int hz, final int msecs) {
        ...
        /**
         * @see javax.sound.sampled.AudioFormat.Encoding.PCM_SIGNED
         */
